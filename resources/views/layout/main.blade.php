    ...
    <section class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <div class="container-fluid">
              <a class="gambar">
                <img src="{{ asset('nusa putra/asset/logo.png') }}">
              </a>
              ...
              <a class="gambar1 mr-4">
                  ...
                  <img src="{{ asset('nusa putra/asset/indonesia.png') }}">
                  <img src="{{ asset('nusa putra/asset/amerika.png') }}">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/berita11">Berita</a>
                     </li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item">
   ...
   <footer>
     <div class="" style="background-color: rgb(53, 52, 52); color: blanchedalmond;">
       ...
       <div class="konten1" style="display: flex;;">
         <div class="collom">
           <img src="{{ asset('nusa putra/asset/universitas.png') }}" style="width: 100px; margin-left: 200px;">
         </div>
