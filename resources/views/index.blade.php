  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-bottom: 100px;">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" >
        <img src="{{ asset('nusa putra/asset/1.jpg') }}" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item" >
        <img src="{{ asset('nusa putra/asset/perpus.jpg') }}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item" >
        <img src="{{ asset('nusa putra/asset/perpus (2).jpg') }}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Perpustakaan </h5>
                  ...
                  <div class="col-sm">
                    <div class="card" style="width: 18rem;">
                      <a href="#" class="btn" bg-white>
                        ...
                        <img src="{{ asset('nusa putra/asset/info1.jpg') }}" class="card-img-top" alt="...">
                  ...
                  <div class="col-sm">
                    <div class="card" style="width: 18rem;">
                      <a href="#" class="btn" bg-white>
                        ...
                        <img src="{{ asset('nusa putra/asset/info2.jpg') }}" class="card-img-top" alt="...">
                  ...
                  <div class="col-sm">
                    <div class="card" style="width: 18rem;">
                      <a href="#" class="btn" bg-white>
                        ...
                        <img src="{{ asset('nusa putra/asset/info3.jpg') }}" class="card-img-top" alt="...">
                        <div class="text"  style="margin-bottom: 50px;">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm bg-light">
                <a class="gambar11">
                  <img src="{{ asset('nusa putra/asset/10.PNG') }}">
                </a>
...
<section id="4 mb-5" style="margin-bottom: 100px;">
        <section class="container-lg">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-xl">
                <img src="{{ asset('nusa putra/asset/brosur1.jpg') }}" >
                <button type="button" class="btn btn-outline-secondary"><b>Download Browsure</b>>></button>
              </div>
              <div class="col-sm">
                <img src="{{ asset('nusa putra/asset/brosur2.jpg') }}">
        ...
        <section class="container5">
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm">
                <img src="{{ asset('nusa putra/asset/berita1.PNG') }}">
              ...
              <div class="col-sm">
                <img src="{{ asset('nusa putra/asset/berita2.PNG') }}">
              ...
              <div class="col-sm">
                <img src="{{ asset('nusa putra/asset/berita3.PNG')}}">
    ...
    <section id="6" style="margin-bottom: 100px;">
        <section class="container6">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm">
                <img src="{{ asset('nusa putra/asset/Rektor.jpg') }}">
              </div>
              <div class="col-sm">
                <img src="{{ asset('nusa putra/asset/trilogi.PNG') }}">
              </div>
            </div>
          </div>
        </section>
  ...
  <div class="container" style="margin-bottom: 100px;">
    ...
    <div class="conten" style="display: flex;">
      <div class="collom">
        <img src="{{ asset('nusa putra/asset/seamolec.png')  }} "alt="" style="width: 100px; margin-left: 70px;">
        <img src="{{ asset('nusa putra/asset/kbtu2.png')  }} "alt="" style="width: 150px; margin-left: 70px;">
        <img src="{{ asset('nusa putra/asset/sunmoon.png')  }} "alt="" style="width: 100px; margin-left: 70px;">

        <img src="{{ asset('nusa putra/asset/ukm2.png')  }} "alt="" style="width: 150px; margin-left: 70px;">

        <img src="{{ asset('nusa putra/asset/iium2.png')  }} "alt="" style="width: 200px; margin-left: 70px;">
